...
import { clearCompaniesUser, clearSubscriptionUserPlans, getPlans, getSpecificPlan, postCompaniesUser, postSubscriptionUserPlans } from './actions';
...
const initialState: Plans = {
  ...
  companiesUser: { data: null, message: null, status: RequestStatus.idle },
};
...
const planReducer = createReducer<Plans, Action>(initialState)
  ...
  .handleAction(postCompaniesUser.request, state => ({
    ...state,
    companiesUser: {
      data: null,
      message: null,
  ...
  .handleAction(postCompaniesUser.success, (state, action) => ({
    ...state,
    companiesUser: {
      data: action.payload,
      message: null,
  ...
  .handleAction(postCompaniesUser.failure, (state, action) => ({
    ...state,
    companiesUser: {
      data: null,
      message: action.payload.message,
  ...
  .handleAction(clearCompaniesUser, state => ({
    ...state,
    companiesUser: {
      data: null,
      message: null,
