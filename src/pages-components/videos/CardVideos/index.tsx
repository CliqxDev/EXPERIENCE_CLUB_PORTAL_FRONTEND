...
const CardVideos = () => (
  <>
    ...
    <S.Wrapper>
      <S.Content>
      <S.TopCard>
        <S.TitleCard>Vídeos</S.TitleCard>
        <S.SubTitle>Assine plataforma [EXP], para ter acesso aos vídeos!</S.SubTitle>
      </S.TopCard>
      <S.BottomCard>
        <S.TitleCard>Escolha seu plano</S.TitleCard>
        <S.DescriptionCard style={{ marginTop: '1rem' }}>Temos planos individuais e</S.DescriptionCard>
        <S.DescriptionCard> corporativos. Aumente o conhecimento da sua equipe.</S.DescriptionCard>
        <Link href="/plan" style={{ width: '100%', textDecoration: 'none' }}>
          <S.Button>Assine</S.Button>
        </Link>
      </S.BottomCard>
      </S.Content>
    </S.Wrapper>
