...
const showMoreContent = [
  {
    ...
    description: 'JPMorgan Chase’s head of global real estate explains how and why the company is.',
    type: 'Tecnologia',
    iconType: <Image src={shareIcon} alt="Compartilhar" style={{ marginRight: '1rem' }} />,
  },
  {
    banner: <Image width={150} height={150} src={bannerCard} alt="Banner" />,
    title: 'Lorem ipsum dolor sit amet consecter.',
